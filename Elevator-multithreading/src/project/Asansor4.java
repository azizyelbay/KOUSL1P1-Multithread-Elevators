...
public class Asansor4 implements Runnable {
    ...
    public Asansor4(NewJFrame gelen_g, int gelen_no, BlockingQueue gelen_musteri_sayisi, BlockingQueue gelen_gidilecek_kat,
    ...
    public void run() {
        ...
        while (true) {
            ...
            if (common.asansor4_calısıyormu == true) {
                    ...
                    while (musteri_sayisi.hasNext()) {
                        ...
                        if (toplam >= 10) {
                            ...
                            try {
                                ...
                                Logger.getLogger(Asansor4.class.getName()).log(Level.SEVERE, null, ex);
                            }
                            try {
...
if ((destination==4&&floor==4&&dorduncu_kat_kuyrugu.isEmpty())||(destination==3&&floor==3&&ucuncu_kat_kuyrugu.isEmpty())||(destination==2&&floor==2&&ikinci_kat_kuyrugu.isEmpty())||(destination==1&&floor==1&&birinci_kat_kuyrugu.isEmpty())) {
                ...
                System.out.print(asansor_gidilecek_kat_no.next() + "]  , ");*/
                        ...
                        g.asansor4_kuyruk(kuyruk_gonder);
                    }
                    try {
                        Thread.sleep(200);
                    } catch (InterruptedException ex) {
